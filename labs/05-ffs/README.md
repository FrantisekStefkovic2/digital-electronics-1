...
1. Write characteristic equations and complete truth tables for D, JK, T flip-flops where `q(n)` represents main output value before the clock edge and `q(n+1)` represents output value after the clock edge.
   ...
   **D-type FF**
   ...
   | ![rising](images/eq_uparrow.png) | 1 | 0 | 0 | input signal is sampled at the rising edge of clk and stored to FlipFlop |
   | ![rising](images/eq_uparrow.png) | 1 | 1 | 1 | input signal is sampled at the rising edge of clk and stored to FlipFlop |
